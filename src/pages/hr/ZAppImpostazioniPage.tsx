...
import { ArrowLeft, Bell, Loader2, Settings, Mail, MessageSquare, Plus, Trash2, User, ChevronDown, ChevronUp } from "lucide-react";
...
const EVENT_SECTIONS: { type: NotificationEventType; label: string; description: string; color: string; icon: string }[] = [
  { type: "nuova_commessa", label: "Nuova Commessa", description: "Notifica alla creazione di una commessa", color: "bg-blue-100 text-blue-800", icon: "📋" },
  { type: "cambio_stato_commessa", label: "Cambio Stato Commessa", description: "Notifica quando una commessa cambia stato", color: "bg-amber-100 text-amber-800", icon: "🔄" },
  { type: "nuovo_ordine", label: "Nuovo Ordine di Vendita", description: "Notifica alla creazione di un ordine di vendita", color: "bg-green-100 text-green-800", icon: "🛒" },
  { type: "nuovo_ordine_acquisto", label: "Nuovo Ordine di Acquisto", description: "Notifica alla creazione di un ordine di acquisto", color: "bg-purple-100 text-purple-800", icon: "📦" },
  { type: "cambio_stato_ordine_acquisto", label: "Cambio Stato Ordine Acquisto", description: "Notifica quando un ordine di acquisto cambia stato", color: "bg-indigo-100 text-indigo-800", icon: "🔃" },
  { type: "scadenza_imminente", label: "Scadenza Imminente", description: "Notifica quando una commessa è vicina alla deadline", color: "bg-red-100 text-red-800", icon: "⏰" },
];
