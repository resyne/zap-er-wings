...
import { Users, Coffee, UserCheck, UserX } from "lucide-react";
...
export default function DashboardTab() {
  ...
  const statusBadge = (s: EmployeeStatus["status"]) => {
    const map = {
      working: { label: "Presente", className: "bg-emerald-500 text-white" },
      on_break: { label: "In pausa", className: "bg-amber-500 text-white" },
      absent: { label: "Assente", className: "" },
      travel: { label: "Trasferta", className: "bg-blue-500 text-white" },
    };
    const cfg = map[s];
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader><CardTitle>Stato Dipendenti</CardTitle></CardHeader>
        <CardContent>
