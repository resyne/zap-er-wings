-- Remove old test orders and add new ones for current week (2025)
DELETE FROM work_orders WHERE number IN ('WO-2024-0001', 'WO-2024-0002', 'WO-2024-0003', 'WO-2024-0004');

-- Insert new work orders for current week in 2025
...
('WO-2025-0005', 'Controllo Finale Sistema XYZ', 'draft', '2025-09-05 16:00:00+00', 'Area Controlli');